...
```{r}
# Shiny inputs for the Core Fidnings page go here - these are all the ways to sort / filter the big list of findings

# Filter by topic
selectInput(
  inputId = 'topicFilter',
  choices = c("General Understanding", "Verbal Expressions", "Formats & Framing", "Visualizations", "Probabilistic vs. Deterministic", "Opinions / Perceptions", "Affect / Emotion", "Small / Long-term Risk"),
  multiple = TRUE,
  label = 'Filter Recommendations by Topic'
)

# Filter / sort by number of supporting studies
