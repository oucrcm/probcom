...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-218322184-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-218322184-2');
</script>
</head> 
...
recs_data <- tibble(
  Recommendation = c(
    "Use probability information in place of deterministic statements in forecasts.",
    "Use numeric point estimates if they are available and appropriate; if they are not, use numeric probability ranges or predictive intervals to emphasize uncertainty.",
    "Include numeric translations next to words/phrases that indicate probability information.",
    "If comprehension of probability information is especially important, use numeric probabilities alone or first (before words/phrases).",
    "When using words and phrases to communicate probability information, include rank adjectives (like low, medium, and high) to indicate the magnitude of the probability; this is especially important if numeric translations are not available.",
    "Use probability (percentage) formats when possible; frequency (fraction) formats can be effective, but they can also generate confusion.",
    "Include information about the reference class when using probability information.",
    "Be aware of directionality; positive statements, which focus on the probability that an event will happen, can promote overestimation and unnecessary protective actions; negative statements, which focus on the probability that an event will not happen can promote underestimation and underreaction.",
    "When possible, include probability information in forecast visualizations.",
    "Use visualizations to increase comprehension of probability information; icon arrays and ensemble plots can be especially effective when teaching people how to interpret probability information. Note: this might not be appropriate immediately before or during high impact events.",
    "Pay attention to the audience when using probability information; most people can grasp basic probability information, but depth of comprehension depends on numeracy and experience."),
  Example = c(
    "Replace: These storms will cause heavy downpours and flooding.<br/>With: There is an extremely high (90%) chance that these storms will cause heavy downpours and flooding.",
    "Replace: The forecast is rapidly evolving, but we may see more than 10 inches of snow in the metro area tomorrow morning.<br/>With (point estimate): The forecast is rapidly evolving, but there is a 15% chance that we will see more than 10 inches of snow in the metro area tomorrow morning.<br/>Or (predictive interval): The forecast is rapidly evolving, but there is a 50% chance that we will see 6 to 14 inches of snow in the metro area tomorrow morning.",
    "Replace: Thunderstorms are possible this evening.<br/>With: Thunderstorms are possible (30% chance) this evening.",
    "Replace: Thunderstorms are possible (30% chance) this evening.<br/>With: There is a 30% chance of thunderstorms this evening.",
    "Replace: There is a chance of snow and ice this morning along I-75.<br/>With: There is a low/medium/high chance of snow and ice this morning along I-75.",
    "Replace: There is a 1 in 10 chance that this storm will produce a tornado.<br/>With: There is a 10% chance that this storm will produce a tornado.",
    "Replace: There is a low chance of tornadoes in the Oklahoma City metro area tomorrow afternoon and evening.<br/>With: There is a low (2%) chance of tornadoes in the Oklahoma City metro area tomorrow afternoon and evening; on 1 in 50 days like today, there will be a tornado within 25 miles of your location.",
    "Positive statement: There is a small chance of drizzle this morning.<br/>Negative statement: Drizzle is unlikely this morning.",
    "Supplement: Maps showing deterministic warning boxes/polygons.<br/>With: Maps showing probability information; for example: probability grids (FACETs); Potential Storm Surge Flooding map (NHC).",
    "Supplement: Models indicate that there is an 80% to 90% chance that hurricane force winds will affect Miami, FL in the next 5 days.<br/>With: Probabilistic wind speed graphic with an icon array that explains the probability information in the product.",
    ""),
  `Exemplary Studies` = c(
    "<a href='https://doi.org/10.1037/a0025185'>Joslyn & LeClerc (2012);<a><br/><a href='https://doi.org/10.1037/xap0000165'>Grounds & Joslyn (2018)<a>",
    "<a href='https://doi.org/10.1155/2017/3932565'>Grounds et al (2017);<a><br/><a href='https://doi.org/10.1002/bdm.2132'>Løhre et al. (2019)<a>",
    "<a href='https://doi.org/10.1038/nclimate2194'>Budescu et al. (2014)<a>",
    "<a href='https://doi.org/10.1080/13669877.2018.1440415'>Jenkins et al. (2019)<a>",
    "<a href='https://doi.org/10.15191/nwajom.2020.0805'>Lenhardt et al. (2020)<a>",
    "<a https://doi.org/10.1177/0272989X08315246'>Cuite et al. (2008)<a>;<br/><a href='https://doi.org/10.1002/met.121'>Joslyn & Nichols (2009)<a>",
    "<a https://doi.org/10.1111/j.1539-6924.2005.00608.x'>Gigerenzer et. al. (2005);<a><br/><a https://doi.org/10.1080/20445911.2018.1553884'>Juanchich & Sirota (2018)<a>",
    "<a https://doi.org/10.1080/17470218.2016.1225779'>Honda & Yamagishi (2017);<a><br/><a https://doi.org/10.1002/bdm.432'>Teigen & Brun (2003)<a>",
    "<a href='https://doi.org/10.1175/WCAS-D-18-0094.1'>Gerst et al. (2020)<a>",
    "<a href='https://doi.org/10.1177/1473871618807121'>Toet et al. (2019);<a><br/><a href='https://doi.org/10.1002/bdm.1797'>Garcia-Retamero & Cokely (2014)<a>",
    "<a href='https://doi.org/10.1111/j.1539-6924.2009.01279.x'>Dieckmann et al. (2009)<a>"))

  DT::datatable(recs_data,
              rownames = TRUE,
              style = "bootstrap",
              options = list(dom = "Brtip", pageLength = 11, ordering = FALSE),
              escape = FALSE, 
              fillContainer = FALSE)
```
